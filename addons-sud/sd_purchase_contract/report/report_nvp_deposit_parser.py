...
class Parser(models.AbstractModel):
    _name = 'report.nvp_report_deposit'
    _inherit = ['report.report_aeroo.abstract']
    _description = 'report.nvp_report_deposit'
    ...
    def get_myear(self,date_fix):
        ...
        date = self.env['res.users']._convert_user_datetime(fields.Datetime.to_string(date_fix))
