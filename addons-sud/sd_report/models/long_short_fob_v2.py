...
class LongShortFOB(models.Model):
    ...
    quality = fields.Char(string='', size=256)
    external_number = fields.Char(string='External NUmber', size=64)
    commodity_type = fields.Char(string='Commodity Type', size=64)
