...
class Parser(models.AbstractModel):
    _name = 'report.report_materials_request_warehouse'
    _inherit = ['report.report_aeroo.abstract']
    _description = 'report.report_materials_request_warehouse'
...
#                         'qty':allocation_id.contract_id and allocation_id.contract_id.qty_allocate or 0})
    ...
    def get_first_weight(self,o):
        return sum(o.move_lines.mapped('first_weight')) or 0
    
    def get_second_weight(self,o):
        return sum(o.move_lines.mapped('second_weight')) or 0
    
    def get_bag_no(self,o):
        return sum(o.move_lines.mapped('bag_no')) or 0
    
    def get_gross_weight(self,o):
        return sum(o.move_lines.mapped('init_qty')) + sum(o.move_lines.mapped('tare_weight'))
    
    def get_init_qty(self,o):
        return sum(o.move_lines.mapped('init_qty'))
    
    def get_tare_weight(self,o):
        return sum(o.move_lines.mapped('tare_weight'))
    
    def get_packing(self,o):
        return ', \n'.join(map(str, [x.packing_id.name for x in o.move_lines]))
