...
class Parser(models.AbstractModel):
    _name = 'report.report_stock_card'
    _inherit = ['report.report_aeroo.abstract']
    _description = 'report.report_stock_card'
...
#                         'qty':allocation_id.contract_id and allocation_id.contract_id.qty_allocate or 0})
    ...
    def get_do(self,o):
        ...
        for line in self.env.cr.dictfetchall():
            delivery = self.env['delivery.order'].browse(line['id'])
    ...
    #     img = qrcode.make(name)
        ...
        # tf = StringIO()
        # img.save(tf, 'png')
        # size_x = str(img.size[0]/96.0)+'in'
        # size_y = str(img.size[1]/96.0)+'in'
    ...
    def makeQRcode(self, name=None, size=2):
        ...
        return temp, 'image/png', size_x, size_y
