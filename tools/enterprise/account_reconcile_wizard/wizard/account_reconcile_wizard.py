...
class AccountReconcileWizard(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        move_line_ids._backport_check_amls_exigibility_for_reconciliation(shadowed_aml_values=shadowed_aml_values)
    ...
    def _compute_reco_wizard_data(self):
        ...
        for wizard in self:
            ...
            plan_list, all_amls = amls._backport_optimize_reconciliation_plan([amls], shadowed_aml_values=shadowed_aml_values)
            ...
            amls\
                ...
                ._backport_prepare_reconciliation_plan(plan, aml_values_map, shadowed_aml_values=shadowed_aml_values)
            ...
            residual_amounts = {
                aml: aml._backport_prepare_move_line_residual_amounts(aml_values, reco_currency, shadowed_aml_values=shadowed_aml_values)
    ...
    def reconcile(self):
        ...
        self.env['account.move.line']._backport_reconcile_plan(amls_plan)
