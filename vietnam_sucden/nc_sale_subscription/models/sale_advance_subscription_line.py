...
class AdvanceSaleSubscriptionLine(models.Model):
    _name = 'advance.sale.subscription.line'
    ...
    def create(self, vals_list):
        for vals in vals_list:
            ...
            if 'price_unit' not  in vals:
                vals['price_unit'] = 1
        sale_subscription_line_ids = super(AdvanceSaleSubscriptionLine, self).create(vals_list)
