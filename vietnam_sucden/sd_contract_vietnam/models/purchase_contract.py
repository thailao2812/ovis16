    ...
    def _amount_all(self):
        for contract in self:
            ...
            contract.update({
                ...
                'total_pay_goods': sub_rel + amount + amount_deposit - sum(contract.offset_debt_ids.mapped('amount')) - sum(contract.payment_ids.filtered(lambda x: x.state == 'posted' and not x.request_payment_id.payment_tax).mapped('amount')),
