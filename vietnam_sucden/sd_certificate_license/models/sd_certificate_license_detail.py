...
class CertificateLicenseDetail(models.Model):
    ...
    faq_tobe_received = fields.Float(string='FAQ Tobe Received', digits=(12, 2))
    g1_s18_tobe_received = fields.Float(string='G1-S18 Tobe Received', digits=(12, 2))
    g1_s16_tobe_received = fields.Float(string='G1-S16 Tobe Received', digits=(12, 2))
    g2_tobe_received = fields.Float(string='G2 Tobe Received', digits=(12, 2))
    ...
    def init(self):
        ...
        self.env.cr.execute("""
            ...
            SELECT row_number() OVER (ORDER BY license.warehouse_id,ncl.name,license.cert_id DESC) AS id, cert.name cert_name, ncl.name license_number, ncl.type, ncl.expired_date, ncl.state,
