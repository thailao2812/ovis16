...
class ReferenceInformation(models.Model):
    ...
    total_advance_payment_usd = fields.Float(string='Total Advance Payment (USD)', digits=(12, 6), related='request_payment_id.total_advance_payment_usd', store=True, readonly=False)
