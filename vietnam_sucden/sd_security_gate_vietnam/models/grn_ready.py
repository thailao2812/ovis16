    ...
    def compute_paid_qty(self):
        for rec in self:
            ...
            if self.env.context.get('seq'):
                grn_ready_in_current_contract = self.env['grn.ready'].search([
                ...
                if grn_ready_in_current_contract:
                    paid_quantity += sum(grn_ready_in_current_contract.mapped('request_qty'))
