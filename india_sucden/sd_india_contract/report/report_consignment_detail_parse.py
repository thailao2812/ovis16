...
class Parser(models.AbstractModel):
    _name = 'report.contract_consignment_detail_india_report'
    _inherit = ['report.report_aeroo.abstract']
    _description = 'report.contract_consignment_detail_india_report'
    ...
    def get_contract(self, contract):
        if contract:
            regular = contract.npe_ids.mapped('contract_id')
            return regular
